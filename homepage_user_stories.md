...
**Acceptance Criteria:**
1. User name is displayed in the welcome message
2. Message appears after successful login
3. Message updates based on logged-in user

**Priority:** High  
**Story Points:** 3  

**Notes:**
- Should dynamically fetch user name from session
...
**Acceptance Criteria:**
1. Daily progress is shown for each habit
2. Progress is updated regularly
3. Data is clearly visible and easy to understand

**Priority:** High  
**Story Points:** 5  

**Notes:**
- Can be shown using charts or lists
...
2. Completed habits are clearly marked
3. List updates when habits are completed

**Priority:** Medium  
**Story Points:** 3  

**Notes:**
- Helps improve user motivation and tracking
